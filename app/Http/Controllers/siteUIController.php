...
class siteUIController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('index')->with('blog_name' , Setting::first()->blog_name)
                            ...
                            ->with('five_post' , Post::orderBy('created_at','desc')->skip(3)->take(1)->get()->first())
                            ->with('six_post' , Post::orderBy('created_at','desc')->skip(3)->take(1)->get()->first())
                            ->with('seven_post' , Post::orderBy('created_at','desc')->skip(3)->take(1)->get()->first())
